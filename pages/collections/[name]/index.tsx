...
export default function Collections({
    ...
    return (
        <>
            <Head>
                <title>Rarity Radar - {name}</title>
                <meta name="title" content={`Rarity Radar - ${name}`} />

                <meta property="og:type" content="website" />
                <meta property="og:title" content={`Rarity Radar - ${name}`} />

                <meta
                    property="twitter:title"
                    content={`Rarity Radar - ${name}`}
                />
            </Head>
            ...
            >
                ...
                >
                    ...
                    {page < Math.round(totalSupply / 25) &&
                        idFilter.length === 0 && (
                            <button
